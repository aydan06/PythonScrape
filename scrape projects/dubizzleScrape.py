...
with open('dubizzle.csv', 'w', encoding='utf8', newline='') as f:
        thewriter = writer(f)
        header = ['Title','Manufacturer','Model','Price', 'Location','Year','Mileage','Number_of_Doors', 'Color']
        ...
        for p in range(1,11):
            ...
            for list in lists:
                ...
                info = [title,manufacturer,model,price, location,year,mileage,doors,color]
